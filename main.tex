...
%This is a significant draw back as the estimate total capacity of all the computers on earth is on the order of $10^24$ which is incredibly small compared to the size of integers we want to factor today. 
|||||
...
\term{Strong Pseudo-prime base a}{We say an integer n is a strong pseudoprime base a is n is an odd composite and \ref{strongpseudo} holds}
